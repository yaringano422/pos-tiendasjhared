...
// Forzamos un bypass de tipos para evitar el conflicto de lectura en node_modules
const Primitive = ResizablePrimitive as any;
const PrimitivePanelGroup = Primitive.PanelGroup;
const PrimitivePanel = Primitive.Panel;
const PrimitivePanelResizeHandle = Primitive.PanelResizeHandle;
